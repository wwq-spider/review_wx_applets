		...
		<view class="consultation" v-for="(item, index) in appointList"  :key="index">
			<view class="consultationr" >
				<view class="title">
					...
					<text style="position: absolute;right: 10rpx;margin-right: 90rpx;">{{item.confirmFlag}}</text>
				...
				<view class="title">
					<view v-if="item.confirmFlag == '待确认'">
						<!-- <text>腾讯会议码:</text> -->
						<view><input :value="item.txNumber" maxlength="18" @input="enterTxNumber" placeholder="请输入腾讯会议码再进行确认" placeholder-style="color:#aba6a4;"></input></view>
					</view>
